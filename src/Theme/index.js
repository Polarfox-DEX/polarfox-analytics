...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#0095FF' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#0095FF',
  primary2: darkMode ? '#3680E7' : '#0095FF',
  primary3: darkMode ? '#4D8FEA' : '#0095FF',
  primary4: darkMode ? '#376bad70' : '#0095FF',
  primary5: darkMode ? '#153d6f70' : '#0095FF',

  // color text
  primaryText1: darkMode ? '#6da8ff' : '#0095FF',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #0095FF 0%, #fff 0%)`
})
